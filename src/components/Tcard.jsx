    ...
    return (
        <div className="tcard">
            <div className="tcard-image">
                <img src="https://source.unsplash.com/WLxQvbMyfas" alt="places visited" />
            </div>
            <div className="tcard-details">
                ...
                <h2 className="tcard-title">Mount Fuji</h2>
                <p className="tcard-description">Mount Fuji is the tallest mountain in Japan, standing at 3,776 meters (12,380 feet). It is a popular tourist site for both Japanese and foreign visitors.</p>
            </div>
        </div>
    );
}
